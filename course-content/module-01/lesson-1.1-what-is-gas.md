...
ก่อนจะลงโค้ดบรรทัดแรก เรามาเข้าใจกันก่อนว่า Google Apps Script (เรียกสั้น ๆ ว่า **GAS**) มันคืออะไร เกิดมาทำอะไร และทำไมคนถึงเลือกใช้
...
> - ถ้าเปรียบเทียบกับ Zapier — GAS เหนือกว่าตรงไหน?
