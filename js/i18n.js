...
ไม่ควรใช้ Key เดียวกับ Key ที่ผูกบิลลิ่ง (ถ้ามี)
        ...
        paymentSuccessDesc: 'รอตรวจสอบยอดเงินและสร้างโค้ด ติดตามสถานะได้ที่หน้าคำสั่งซื้อ',
        paymentOrderId: 'เลขคำสั่งซื้อ',
        paymentGoToOrders: 'ไปหน้าคำสั่งซื้อ',
...
Don't reuse a Key that's linked to a billing account (if any).
        ...
        paymentSuccessDesc: 'Waiting for payment verification and code generation. Track status on the Orders page.',
        paymentOrderId: 'Order ID',
        paymentGoToOrders: 'Go to Orders',
