...
ไม่ควรใช้ Key เดียวกับ Key ที่ผูกบิลลิ่ง (ถ้ามี)
        ...
        // Result
        stepResult: 'ผลลัพธ์',
        signatureWarning: 'โปรดอย่าลบส่วน <strong>KP-PROMPT-CREATOR-SIGNATURE</strong> ด้านล่าง เพื่อให้ตรวจสอบที่มาของ Prompt ได้',
        resetBtn: 'รีเซ็ต',
...
Don't reuse a Key that's linked to a billing account (if any).
        ...
        // Result
        stepResult: 'Result',
        signatureWarning: 'Please keep the <strong>KP-PROMPT-CREATOR-SIGNATURE</strong> section below so this Prompt\'s origin can be verified.',
        resetBtn: 'Reset',
