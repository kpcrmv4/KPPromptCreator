...
ไม่ควรใช้ Key เดียวกับ Key ที่ผูกบิลลิ่ง (ถ้ามี)
        ...
        codegenDesc: 'ได้ไฟล์โค้ดพร้อมใช้ + คู่มือ deploy ใน ZIP เดียว',
        codegenInstallerLabel: 'รวม Auto Installer (setup.bat/sh + GUI สำหรับ deploy อัตโนมัติ)',
        codegenPriceLabel: 'ราคา',
        codegenTierSimple: 'ง่าย',
        codegenTierModerate: 'ปานกลาง',
        codegenTierComplex: 'ซับซ้อน',
        codegenFreeHint: 'หรือ Copy Prompt ด้านบนไปใช้กับ AI เอง (ฟรี)',
        codegenBtn: 'สร้างโค้ด + ดาวน์โหลด ZIP',
...
Don't reuse a Key that's linked to a billing account (if any).
        ...
        codegenDesc: 'Get ready-to-use code files + deploy guide in one ZIP',
        codegenInstallerLabel: 'Include Auto Installer (setup.bat/sh + GUI for auto deploy)',
        codegenPriceLabel: 'Price',
        codegenTierSimple: 'Simple',
        codegenTierModerate: 'Moderate',
        codegenTierComplex: 'Complex',
        codegenFreeHint: 'Or copy the Prompt above and use it with AI yourself (free)',
        codegenBtn: 'Generate Code + Download ZIP',
