...
const PROJECT_TEMPLATES = {
    ecommerce: {
        name: 'ร้านค้าออนไลน์',
        desc: 'เว็บขายของออนไลน์ มีระบบสมัครสมาชิก/login, แสดงรายการสินค้า, ตะกร้าสินค้า, ชำระเงิน, ประวัติการสั่งซื้อ, แดชบอร์ดสำหรับ admin จัดการสินค้าและออเดอร์',
    ...
    inventory: {
        name: 'ระบบจัดการสต็อกสินค้า',
        desc: 'ระบบจัดการสต็อกสินค้า มีระบบ login, เพิ่ม/แก้ไข/ลบสินค้า, ติดตามจำนวนสต็อก, แจ้งเตือนสินค้าใกล้หมด, แดชบอร์ดสรุปยอดขาย, export รายงานเป็น Excel',
    ...
    portfolio: {
        name: 'เว็บ Portfolio',
        desc: 'เว็บแสดงผลงาน Portfolio มีหน้าแนะนำตัว, แสดงผลงาน/โปรเจกต์พร้อมรูปภาพ, ทักษะ/Skills, ประวัติการทำงาน, แบบฟอร์มติดต่อ, ลิงก์ social media',
    ...
    booking: {
        name: 'ระบบจองนัดหมาย',
        desc: 'ระบบจองนัดหมาย มี login สำหรับลูกค้าและ admin, ปฏิทินแสดงช่วงเวลาว่าง, จองนัด/ยกเลิก, แจ้งเตือนผ่าน email, admin จัดการตารางนัด, ประวัติการจอง',
    ...
    dashboard: {
        name: 'แดชบอร์ดสรุปข้อมูล',
        desc: 'แดชบอร์ดแสดงข้อมูลสรุป มีกราฟ/ชาร์ตหลายรูปแบบ, ตารางข้อมูล, กรองตามช่วงวันที่, export เป็น PDF/Excel, รองรับข้อมูล real-time',
    ...
    blog: {
        name: 'เว็บบล็อก',
        desc: 'เว็บบล็อก/CMS มีระบบเขียนบทความพร้อม rich text editor, จัดหมวดหมู่/แท็ก, ค้นหาบทความ, ระบบ comment, admin จัดการบทความ, SEO friendly',
...
function applyTemplate(templateId) {
    ...
    document.getElementById('projectDesc').value = tpl.desc;
    ...
    showToast(`ใช้ template "${tpl.name}" แล้ว!`);
}
...
const USAGE_GUIDES = {
    'claude': [
        'คัดลอกหรือดาวน์โหลดไฟล์ด้านบน',
        'บันทึกเป็นไฟล์ <code>CLAUDE.md</code> ไว้ใน root ของโปรเจกต์',
        'เปิด terminal แล้วพิมพ์ <code>claude</code> เพื่อเริ่ม Claude Code',
        'Claude จะอ่านไฟล์ CLAUDE.md แล้วเข้าใจโปรเจกต์ของคุณอัตโนมัติ'
    ],
    'gemini-cli': [
        'คัดลอกหรือดาวน์โหลดไฟล์ด้านบน',
        'บันทึกเป็นไฟล์ <code>GEMINI.md</code> ไว้ใน root ของโปรเจกต์',
        'เปิด terminal แล้วพิมพ์ <code>gemini</code> เพื่อเริ่ม Gemini CLI',
        'Gemini จะอ่านไฟล์แล้วเข้าใจโปรเจกต์ของคุณ'
    ],
    'cursor': [
        'คัดลอกหรือดาวน์โหลดไฟล์ด้านบน',
        'บันทึกเป็นไฟล์ <code>.cursorrules</code> ไว้ใน root ของโปรเจกต์',
        'เปิดโปรเจกต์ด้วย Cursor Editor',
        'Cursor จะอ่าน .cursorrules แล้วช่วยเขียนโค้ดตามที่กำหนด'
    ],
    'github-copilot': [
        'คัดลอกหรือดาวน์โหลดไฟล์ด้านบน',
        'บันทึกเป็น <code>.github/copilot-instructions.md</code>',
        'เปิดโปรเจกต์ด้วย VS Code ที่มี GitHub Copilot',
        'Copilot จะอ่านคำสั่งแล้วช่วยเขียนโค้ดตามที่กำหนด'
    ],
    'codex': [
        'คัดลอกหรือดาวน์โหลดไฟล์ด้านบน',
        'บันทึกเป็นไฟล์ <code>AGENTS.md</code> ไว้ใน root ของโปรเจกต์',
        'เปิด terminal แล้วพิมพ์ <code>codex</code> เพื่อเริ่ม Codex CLI',
        'Codex จะอ่าน AGENTS.md แล้วทำงานตามคำสั่ง'
    ],
    'windsurf': [
        'คัดลอกหรือดาวน์โหลดไฟล์ด้านบน',
        'บันทึกเป็นไฟล์ <code>.windsurfrules</code> ไว้ใน root ของโปรเจกต์',
        'เปิดโปรเจกต์ด้วย Windsurf Editor',
        'Windsurf จะอ่าน .windsurfrules แล้วช่วยเขียนโค้ดตามที่กำหนด'
    ],
    'other': [
        'คัดลอกหรือดาวน์โหลดไฟล์ด้านบน',
        'บันทึกเป็นไฟล์ <code>AI_INSTRUCTIONS.md</code> ไว้ใน root ของโปรเจกต์',
        'เปิด AI tool ของคุณแล้ววางเนื้อหาไฟล์ หรือชี้ไปที่ไฟล์นี้',
        'AI จะเข้าใจโปรเจกต์ของคุณแล้วช่วยสร้างตามคำสั่ง'
    ]
};
...
function renderUsageGuide(targetAI) {
    ...
    const steps = USAGE_GUIDES[targetAI] || USAGE_GUIDES['other'];
